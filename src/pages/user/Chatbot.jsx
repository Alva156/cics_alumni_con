...
function Chatbot() {
  ...
  const results = {
    ...
    // Certifications
    "Computer Science Certification": "Certification result for Computer Science",
    "Information Systems Certification": "Certification result for Information Systems",
    "Information Technology Certification": "Certification result for Information Technology",
  ...
  const goBack = () => {
    if (stepHistory.length > 0) {
      ...
      if (previousStep === 2) {
        ...
        addChatMessage("chatbot", ["Navigation", "Documents", "Certifications", "Jobs"]);
  ...
  const handleMainOptionClick = (option) => {
    ...
    setTimeout(() => {
      ...
      if (option === "Navigation") {
        ...
        options = ["Available Documents", "How to Request", "Contact Details", "Go back"];
      } else if (option === "Certifications") {
        options = ["Computer Science Certification", "Information Systems Certification", "Information Technology Certification", "Go back"];
      } else if (option === "Jobs") {
        options = ["Computer Science Job", "Information Systems Job", "Information Technology Job", "Go back"];
      }
  ...
  const handleSubOptionClick = (subOption) => {
    ...
    setTimeout(() => {
      ...
      addChatMessage("chatbot", `You selected ${subOption}. Here are your results:`);
  ...
  return (
    <div className="text-black font-light mx-4 md:mx-8 lg:mx-16 mt-8 mb-12">
      ...
      {/* Chat Container */}
      <div className="w-full h-[62vh] bg-white p-6 rounded-lg shadow-lg flex flex-col space-y-4 overflow-auto" ref={chatContainerRef}>
        {/* Chat Messages */}
