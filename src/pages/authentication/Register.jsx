      ...
      <div className="flex flex-col md:flex-row h-screen overflow-hidden">
        ...
        <div className="w-full md:w-1/2 p-3 md:p-5 flex flex-col justify-start bg-white">
          <div className="flex flex-col px-4 md:px-8"> 
            ...
            <label className="block mb-1 mt-2 text-xs font-medium">Student ID Number</label>
            <input
              type="text"
              placeholder="Enter your Student ID Number"
              className="mb-3 p-2 border border-black bg-[#D9D9D9] rounded w-full"
              style={{ height: '32px' }}
            />
            ...
            <label className="block mb-1 text-xs font-medium">Contact Number *</label>
            <input
              type="tel"
            ...
            <label className="block mb-1 text-xs font-medium">Confirm Password *</label>
            <div className="relative mb-3">
              <input
            ...
            <button
              className="bg-[#BE142E] text-white font-bold text-sm py-2 px-4 rounded w-full mb-2 transition duration-300 ease-in-out hover:bg-[#a10c2b]"
            >
              SIGN UP
            </button>
            ...
            <button
              className="bg-[#2D2B2B] text-white font-bold text-sm py-2 px-4 rounded w-full transition duration-300 ease-in-out hover:bg-[#1a1a1a]"
            >
              SIGN IN
            </button>
          </div>
