        ...
        <div className="w-full md:w-1/2 p-6 md:p-10 flex flex-col justify-start bg-white">
          <div className="flex flex-col justify-start h-full px-4 md:px-8"> {/* Added padding here */}
            ...
            <input
              ...
              className="mb-6 p-2 border border-black bg-[#D9D9D9] rounded w-full"
              style={{ height: '40px' }}
            />
            ...
            <button
              className="bg-[#BE142E] text-white font-bold text-lg py-3 px-6 rounded w-full mb-6 transition duration-300 ease-in-out hover:bg-[#a10c2b]"
            >
              SIGN IN
            </button>
            ...
            <button
              className="bg-[#2D2B2B] text-white font-bold text-lg py-3 px-6 rounded w-full transition duration-300 ease-in-out hover:bg-[#1a1a1a]"
            >
              SIGN UP
            </button>
          </div>
